...
//		}
	...
	public Map<String, String> uploadPhoto(MultipartFile photo,HttpServletRequest request){
		...
		String savePath = request.getServletContext().getRealPath("/") + "resources/upload/".replaceAll("/", "\\\\");
		...
		try {
			...
			//System.out.println("我在保存图片,路径是："+savePath);
		}catch (Exception e) {
		...
		ret.put("type", "success");
		ret.put("msg", "用户删除成功！");
		ret.put("filepath",request.getServletContext().getContextPath() + "/resources/upload/" + filename );//这里可以让上传的图片实时显示出来
		return ret;
	}
	/**
	 * 判断该用户名是否存在
