...
<body>
	<div id="wrapper" class="viewer">
		<div id="sidebar-wrapper">
			<div class="well sidebar-nav">
				<nav id="J_menuList" class="nav nav-list"></nav>
			</div>
			<footer class="footFix footRight">
				<span id="shop-cart" style="display: block; width: 50px; height: 50px; background: url(../../resources/home/images/cart.png)">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<sup
					id="total-sum" display="font-color:red;">0</sup> <!--span class="num">9</span-->
					</sapn>
			</footer>
		</div>
		<div id="page-content-wrapper" class="">
			<div class="page-content">
				<div class="container" id="J_list_Container"></div>
			</div>
		</div>
	...
	<div id="wrapper2" class="viewer wrapper countpage clearfix"
			...
			<div class="container" id="">
				<div class="col-md-12 clearfix foot_orderList">
					<div class="row">
						...
						<div class="col-xs-6">
							<p class="notice tar">
								共计 <span class="price" id="price_txt"> 315元 </span>
							</p>
						</div>
					</div>
				</div>
		...
		<section class="oder_content">
			<div class="container" id="J_order_list"></div>
		</section>
		<section class="oder_submit">
			<div class="container">
				<a style="" href="../user/index"
					class="button button-rounded button-flat-action fr mgtbr8">
					我的中心 </a>
				<button class="button button-rounded button-flat-action fr mgtbr8"
					id="submitOrder">下单</button>
			</div>
		</section>
	</div>
				...
				<div class="col-xs-12 foot-info">
					<div class="imgViewer_contain">
						...
						<div id="J_imgInfo" class="info_contain clearfix">
							<strong> 芒果布丁2 </strong> <span class="colred"> 888元/粒 </span> <small>
								524人买过 </small>
						</div>
					</div>
				</div>
					...
					<div class="now_submit clearfix">
						<form id="submit-order-form">
							...
							<div class="form-group" id="form_info">
								<label for="phone"> 手机号码 </label> <span
									class="twitter-typeahead"> <input type="text"
									id="add-phone" name="phone" class="form-control tt-query"
									autocomplete="off" spellcheck="false" dir="auto">
								</span> <label for="name" class="mgt10"> 姓名 </label> <span
									class="twitter-typeahead"> <input type="text"
									id="add-recieveName" name="recieveName"
									class="form-control tt-query" autocomplete="off"
									spellcheck="false" dir="auto">
								</span> <label for="adress" class="mgt10"> 地址 </label> <span
									class="twitter-typeahead"> <input type="text"
									id="add-address" name="address" class="form-control tt-query"
									autocomplete="off" spellcheck="false" dir="auto">
								</span>
							</div>
							<div class="form-group">
								<div class="btn_control fr">
									<a class="btn btn-default bottommargin" id="cancelSubmit">
										取消 </a> <a class="btn btn-info bottommargin"
										id="submit-order-action"> 确认 </a>
								</div>
							</div>
						</form>
					</div>
	...
	<div id="loadingView" class="viewer">
		<div class="container">
			<div class="col-md-12 clearfix loading"></div>
		</div>
	</div>
	<!-- Le javascript
    ================================================== -->
