...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>菜品名称:</label><input id="search-name" style="height:20px;" class="wu-text" style="width:100px">
            <label>所属分类:</label>
...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            <tr>
                <td width="70" align="right">图片预览:</td>
                <td valign="middle">
            ...
            <tr>
                ...
                <td><input type="text" style="height:20px" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写菜品名称'" /></td>
            </tr>
            <tr>
                <td width="70" align="right">价格:</td>
                <td><input type="text" style="height:20px" name="price" type="number" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写价格'" /></td>
            </tr>
            <tr>
                <td width="70" align="right">所属分类:</td>
                <td>
                	<select name="categoryId" class="easyui-combobox" panelHeight="auto" style="width:260px" data-options="required:true, missingMessage:'请选择角色'">
		                <c:forEach items="${foodCategoryList }" var="foodCategory">
		            		<option value="${foodCategory.id }">${foodCategory.name }</option>
		            	</c:forEach>
		            </select>
            ...
            <tr>
                <td width="70" align="right">菜品描述:</td>
                <td>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            ...
            <tr>
                <td width="70" align="right">图片:</td>
                <td><input type="text" style="height:20px" id="edit-photo" name="imageUrl" value="/BookDinner/resources/admin/easyui/images/user_photo.jpg" readonly="readonly" class="wu-text " /></td>
            </tr>
            <tr>
                <td width="70" align="right">名称:</td>
                <td><input type="text" style="height:20px" id="edit-name" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写菜品名称'" /></td>
            </tr>
            <tr>
                <td width="70" align="right">价格:</td>
                <td><input type="text" style="height:20px" id="edit-price" type="number" name="price" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写价格'" /></td>
            </tr>
            <tr>
                <td width="70" align="right">所属分类:</td>
                <td>
                	<select id="edit-categoryId" name="categoryId" class="easyui-combobox" panelHeight="auto" style="width:260px" data-options="required:true, missingMessage:'请选择角色'">
		                <c:forEach items="${foodCategoryList }" var="foodCategory">
		            		<option value="${foodCategory.id }">${foodCategory.name }</option>
		            	</c:forEach>
		            </select>
