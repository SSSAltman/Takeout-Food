...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>角色名称:</label><input id="search-name" class="wu-text" style="width:100px; height: 20px;">
	...
	<form id="add-form" method="post">
        <table>
            <tr>
                ...
                <td><input type="text" style="height:20px;" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写角色名称'" /></td>
            </tr>
            <tr>
...
<div id="edit-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:450px; padding:10px;">
	<form id="edit-form" method="post">
        ...
        <table>
            <tr>
                <td width="60" align="right">角色名称:</td>
                <td><input type="text" style="height:20px;" id="edit-name" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写角色名称'" /></td>
            </tr>
            <tr>
                <td align="right">角色备注:</td>
	...
	*/
	...
	function isAdded(row,rows){
		for(var k=0;k<existAuthority.length;k++){
			/* console.log('existAuthority[k].menuId---'+existAuthority[k].menuId+'---row.parentId----'+row.parentId+'---row.id---'+row.id+'---haveParent(rows,row.parentId)---'+haveParent(rows,row.parentId));
                ...
                handler: function(){
                	...
                	if(ids != ''){
                		...
                		$.ajax({
                			...
                			success:function(data){
                				if(data.type == 'success'){
                					$.messager.alert('信息提示','权限编辑成了！下次登陆生效','info');
