...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        ...
        <div class="wu-toolbar-search">
            <label>用户名:</label><input id="search-name" class="wu-text" style="width:100px;height:20px;">
            <label>状态:</label>
	...
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
                ...
                <td><input type="text" style="height:20px;" id="edit-recieveName" name="recieveName" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写联系人'" /></td>
            </tr>
            <tr>
                <td align="right">手机号:</td>
                <td><input type="text" style="height:20px;" id="edit-phone" name="phone" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写联系人手机号码'" /></td>
            </tr>
            <tr>
                <td align="right">送货地址:</td>
                <td><input type="text" style="height:20px;" id="edit-address" name="address" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写送货地址'" /></td>
            </tr>
            <tr>
                <td align="right">状态:</td>
                <td>
                	<select id="edit-status" name="status" class="easyui-combobox" panelHeight="auto" style="width:260px">
		                <option value="0">待发货</option>
            			<option value="1">已发货</option>
            			<option value="2">已完成</option>
		            </select>
...
<script type="text/javascript">
	...
	*/
	function remove(){
		$.messager.confirm('信息提示','确定要删除该订单？', function(result){
			if(result){
				var item = $('#data-datagrid').datagrid('getSelected');
				if(item == null || item.length == 0){
